...
import com.thedeveloper.garant.util.storage.StorageException;
import com.thedeveloper.garant.util.storage.StorageFileNotFoundException;
...
public class ImageService implements StorageService {
    ...
    @Override
    public void init() {
        System.out.println("Image INIT Abs: "+rootLocation.toAbsolutePath());
        try {
