...
import com.thedeveloper.garant.util.storage.*;
...
@Service
public class DealsFilesService implements StorageService {
    private final Path rootLocation;

    public DealsFilesService(DealImageProperties properties) {
        this.rootLocation = Paths.get(properties.getLocation());
    }

    @Override
    public void init() {
        System.out.println("DealsFiles INIT Abs: "+rootLocation.toAbsolutePath());
        try {
    ...
    public void store(MultipartFile file) {
        ...
        System.out.println("File to "+filel.getAbsolutePath());
