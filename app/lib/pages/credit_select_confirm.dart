...
class CreditSelectConfirm extends StatefulWidget{
  String creditId;

  CreditSelectConfirm({required this.creditId, super.key});

  @override
  State<StatefulWidget> createState() => _CreditSelectConfirm();

}
class _CreditSelectConfirm extends State<CreditSelectConfirm>{
  String? code;
  @override
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    client.creditSelect(Globals.getToken(), widget.creditId, code!).then((value){
